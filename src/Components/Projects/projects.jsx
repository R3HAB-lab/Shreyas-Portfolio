...
const Projects = () => {
  // State to manage modal visibility and active game URL/Title
  ...
  const projectData = [
    {
      ...
      description: "Designed and built a 3D stereoscopic data visualization app; planned and executed a full test cycle including live user testing and QA sign-off for a mixed-reality application.",
      githubLink: "https://github.com/R3HAB-lab/Hololens_Project_Msc",
      playLink: null
    },
    {
      title: "SuperShooter",
      ...
      tech: ["Unity", "C#"],
      description: "Game prototype focused on avoiding enemies and collecting health items with a little TPS (Third Person Shooter). Combat will consist of shooting projectiles at enemies and collecting required items.",
      playLink: "https://play.unity.com/api/v1/games/game/ee3d6a08-4a4f-487b-b003-52c5c8cad3c5/build/latest/frame",
      githubLink: null
    },
    {
        ...
        {projectData.map((project, index) => (
          <div key={index} className="project-card">
            ...
            {project.playLink ? (
              ...
              <span className="project-no-link">Academic Project</span>
            )}
          </div>
        ))}
      </div>
